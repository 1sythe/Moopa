...
export default function About() {
  return (
    <>
      <Head>
        <title>Sakura - About</title>
        <meta name="title" content="About" />
        <meta
          name="description"
          content="Sakura is a platform where you can watch and stream anime or read
      ...
      >
        <div className="max-w-screen-lg w-full px-4 py-10">
          ...
          <p className="text-lg mb-8">
            Sakura is a platform where you can watch and stream anime or read
