...
export default function Recent({ sessions }) {
  ...
  return (
    <Fragment>
      <Head>
        <title>Sakura - New Episodes</title>
        <meta name="title" content="New Episodes" />
        <meta
          name="description"
          content="Explore Beloved Classics and Favorites - Dive into a curated collection of timeless anime on Sakura's New Episodes Page. From iconic classics to all-time favorites, experience the stories that have captured hearts worldwide. Start streaming now and relive the magic of anime!"
        />
      </Head>
