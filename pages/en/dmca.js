...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>Sakura - DMCA</title>
        <meta name="DMCA" content="DMCA" />
        <meta property="og:title" content="DMCA" />
        <meta
          property="og:description"
          content="anime.sythe.cloud is committed to respecting the intellectual
          ...
          <div className="px-5 lg:px-0 lg:w-[75%] text-2xl gap-7 flex flex-col my-[10rem]">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-3 text-[#cdcdcd]">
                <p>
                  anime.sythe.cloud is committed to respecting the intellectual
                  property rights of others and complying with the Digital
              ...
              <p className="text-[#cdcdcd]">
                None of the files listed on anime.sythe.cloud are hosted on our
                servers. All links point to content hosted on third-party
                websites. anime.sythe.cloud does not accept responsibility for content
                ...
                <a
                  href="mailto:contact@sythe.cloud?subject=[Sakura]%20-%20Your%20Subject"
